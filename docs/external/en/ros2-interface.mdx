...
|:------|:-----|:-----|:----|:------------|
| `/tactile/raw` | `TactileFrame` | 120 Hz | SensorDataQoS | Raw tactile frame data |
| `/tactile/image` | `sensor_msgs/Image` | 30 Hz (default) | SensorDataQoS | RGB8 24×32 heatmap (JET colormap) |
